...
- An optional figma design not, if a figma design link is present
...
If `figma-hint` is present and Figma MCP tools are available:
...
3. Summarize this as 3 to 8 concise bullet points and also leave a link to the figma component for future lookups.
4. If lookup fails or the tools are available, record a not like:
